...
const Sidebar = ({ isOpen, setIsOpen }) => {
  ...
  return (
    <>
      ...
      {/* Sidebar Aside */}
      <aside 
        className={`fixed top-0 left-0 h-full w-72 bg-slate-900 z-50 flex flex-col transition-transform duration-300 ease-in-out lg:static lg:translate-x-0 shadow-2xl ${
      ...
      >
        ...
        <div className="relative z-10 flex flex-col h-full">
          ...
          <div className="p-6 pb-2 flex items-center justify-between">
            <div className="flex items-center gap-4 p-3 rounded-2xl bg-white/5 border border-white/5 backdrop-blur-md shadow-xl group cursor-default flex-1">
              <div className="relative">
                <div className="absolute inset-0 bg-gradient-to-tr from-blue-500 to-indigo-500 rounded-xl blur opacity-60 group-hover:opacity-80 transition-opacity duration-500"></div>
                <div className="relative bg-gradient-to-tr from-blue-600 to-indigo-600 p-2.5 rounded-xl shadow-inner border border-white/10">
                  <Store className="text-white" size={24} />
