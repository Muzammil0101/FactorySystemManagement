...
// //         fetchCustomers(),
// //         fetchCategories()
// //         // Removed fetchSummary() API call to rely on local calculation
// //       ]);
// //     } catch (error) {
// //       console.error("Error fetching data:", error);
// //       showNotification("Error loading data", "error");
...
//            </h3>
//            <div className="space-y-3 max-h-96 overflow-y-auto pr-2 scrollbar-thin scrollbar-thumb-slate-300 scrollbar-track-transparent">
//               {Array.isArray(stockIn) && stockIn
//                 .filter(item => item.supplier !== 'Monthly Transfer')
...
//            </h3>
//            <div className="space-y-3 max-h-96 overflow-y-auto pr-2 scrollbar-thin scrollbar-thumb-slate-300 scrollbar-track-transparent">
//               {Array.isArray(stockOut) && stockOut
//                 .filter(item => item.customer !== 'Month End Transfer')
//                 .slice(-5).reverse().map((item, idx) => (
//                 <div key={idx} className="group p-4 bg-white hover:bg-slate-50 rounded-2xl border border-slate-100 hover:border-rose-200 transition-all duration-300 shadow-sm">
//                   <div className="flex justify-between items-start mb-3">
//                     <div>
