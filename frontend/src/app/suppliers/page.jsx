...
// //     try {
// //       // Note: Attachment is UI only for now, not sending to backend
// //       const response = await fetch(`${API_URL}/suppliers/${selectedSupplier.id}/ledger`, {
// //         method: 'POST',
// //         headers: { 'Content-Type': 'application/json' },
// //         body: JSON.stringify({
...
// //     // Note: Totals here only reflect the view, not the lifetime
...
//   ChevronUp,
//   Filter,
//   Scale, // Added for Weight Icon
//   Tag    // Added for Rate Icon
// } from "lucide-react";
...
//   // UPDATED HANDLE CONTRA SETTLEMENT
//   const handleContraSettlement = async () => {
//     if (!contraForm.amount || parseFloat(contraForm.amount) <= 0) {
//       showNotification("Please enter a valid amount", "error");
//       return;
...
//                   value={contraForm.date} 
//                   onChange={e => setContraForm({...contraForm, date: e.target.value})} 
//                   className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-2.5 text-sm text-slate-700 focus:ring-2 focus:ring-purple-500/20 focus:border-purple-500 outline-none"
//                 />
//               </div>
